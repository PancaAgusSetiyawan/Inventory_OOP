...
Public Class rptPenerimaan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INVENTORY.rptPenerimaan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPenerimaan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPenerimaan = New rptPenerimaan
        rpt.Site = Me.Site
        Return rpt
    End Function
